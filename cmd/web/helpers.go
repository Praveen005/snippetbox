...
func (app * application) decodePostForm(r *http.Request, dst any) error {
	...
	if err != nil{
		...
		// Erros as not only compares if the 'err' is of type 'InvalidDecoderError', 
		//but also extracts(copies by reference, but only after errors type match)
		// methods and other fields inside 'err' to 'invalidDecoderError' variable.
		// It goes beyond errors.Is()
...
func(app *application) isAuthenticated(r *http.Request) bool {
	...
	// return app.sessionManager.Exists(r.Context(), "authenticatedUserID") // no need to check the session data and make an additional db call.
}